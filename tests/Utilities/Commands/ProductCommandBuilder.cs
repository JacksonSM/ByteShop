...
public class ProductCommandBuilder
{
    ...
    public static UpdateProductCommand UpdateProductCommandBuild(int numberSecondaryImages = 3)
    {
        return new Faker<UpdateProductCommand>()
            ...
            .RuleFor(c => c.SecondaryImageUrl, f => f.Make(numberSecondaryImages, () => f.Internet.Url()).ToArray());
    }
}